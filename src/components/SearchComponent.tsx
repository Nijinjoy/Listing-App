...
const SearchComponent = () => {
    return (
        <View style={{ flexDirection: 'row', alignItems: 'center', borderWidth: 0.5, padding: WIDTH * 0.005, borderRadius: WIDTH * 0.06, backgroundColor: colors.white, borderColor: colors.grey }}>
